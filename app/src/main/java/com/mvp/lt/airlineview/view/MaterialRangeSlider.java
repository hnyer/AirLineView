...
//        appcompatMaterialStyledAttrs.recycle();
    ...
    private void drawSelectedTargets(Canvas canvas) {
        ...
        canvas.drawCircle(minPosition, midY, minTargetRadius+DensityUtils.dpToPx(3), paint);
        canvas.drawCircle(maxPosition, midY, maxTargetRadius+DensityUtils.dpToPx(3), paint);
        paint2.setColor(Color.parseColor("#ff9CDE"));
        paint2.setTextSize(DensityUtils.dpToPx(10));
        canvas.drawText(String.valueOf(getSelectedMin()), minPosition-DensityUtils.dpToPx(3), midY+DensityUtils.dpToPx(3), paint2);
        canvas.drawText(String.valueOf(getSelectedMax()), maxPosition-DensityUtils.dpToPx(3), midY+DensityUtils.dpToPx(3), paint2);
